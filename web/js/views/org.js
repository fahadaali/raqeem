...
function openBranch(b, reload) {
   ...
   *
   * والخريطة تُسحَب وتُكبَّر وتُبدَّل طبقتها: طبقة القمر الصناعي وحدها تكفي
   * لمعرفة المسجد من سطحه حين لا يُعرَف اسم شارعه.
   */
  const map = geoMap({
    ...
    body: el('div', {}, [
      ...
      el('div.stack', { style: { gap: '8px', marginBlock: '12px' } }, [
        ...
        el('p.hint', { style: { margin: 0 },
          text: 'اسحب الدبّوس إلى موقع المسجد، واسحب ما حوله لتتنقّل في الخريطة، وبدّل الطبقة إلى القمر الصناعي إن كان أوضح. والدائرة هي النطاق الذي يُقبل التحضير داخله.' })
      ]),
